...
class UpdateClientmasterRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'client_name' => 'required|string|max:191|unique:client_name,gst_no,' . $id,
            ...
            'billing_date' => 'required_if:billing_type,1|integer',
