<x-admin.layout>
    <x-slot name="title"> Master Group Category</x-slot>
    <x-slot name="heading"> Master Group Category</x-slot>
                ...
                <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                <label class="col-form-label" for="group_name">Master Group Category Name <span class="text-danger">*</span></label>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="buttons-datatables" class="table table-bordered nowrap align-middle" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($GroupsMasterCategory as $masterGroup)
                                    <tr>
...
<script>
    $("#addForm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ route('group-master-category.store') }}',
            type: 'POST',
            data: formdata,
            contentType: false,
            processData: false,
            success: function(data) {
                ...
                if (!data.error2)
                    ...
                    .then((action) => {
                        window.location.href = '{{ route('group-master-category.index') }}';
                    });
                else
...
<script>
    $("#buttons-datatables").on("click", ".edit-element", function(e) {
        ...
        var url = "{{ route('group-master-category.edit', ':model_id') }}";
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                editFormBehaviour();
                if (!data.error) {
                    $("#editForm input[name='edit_model_id']").val(data.MasterGroupCategory.id);
                    $("#edit_master_group_id").val(data.MasterGroupCategory.master_group_id);
                    $("#edit_group_name").val(data.MasterGroupCategory.group_name);
                    $("#edit_dr_cr").val(data.MasterGroupCategory.dr_cr);
                } else {
                    alert(data.error);
                }
            },
...
<script>
    $(document).ready(function() {
        $("#editForm").submit(function(e) {
            ...
            var url = "{{ route('group-master-category.update', ':model_id') }}";
    ...
    $("#buttons-datatables").on("click", ".rem-element", function(e) {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    var model_id = $(this).attr("data-id");
                    var url = "{{ route('group-master-category.destroy', ':model_id') }}";
