            ...
            <div class="card">
                <form class="theme-form" name="addForm" id="addForm" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            <div class="col-md-4">
                                <label class="col-form-label" for="name">type name <span class="text-danger">*</span></label>
                                <input class="form-control" id="type_name" name="type_name" type="text" placeholder="Enter Type Name">
                                <span class="text-danger invalid type_name_err"></span>
                            </div>
                              <div class="col-md-4">
                                <label class="col-form-label" for="model_no">Description (Model No) <span class="text-danger">*</span></label>
                                <input class="form-control" id="model_no" name="model_no" type="text" placeholder="Enter Model No">
                                <span class="text-danger invalid model_no_err"></span>
                            </div>                            
                                <div class="col-md-4">
                ...
                <div class="card-body py-2">
                    ...
                    <div class="mb-3 row">
                         <div class="col-md-4">
                                ...
                                <input class="form-control" id="edit_type_name" name="type_name" type="text" placeholder="Enter Vehicle Type e.g.:- 20 FT">
                                <span class="text-danger invalid type_name_err"></span>
                            </div>
                            <div class="col-md-4">
                                <label class="col-form-label" for="model_no">Description (Model No) <span class="text-danger">*</span></label>
                                <input class="form-control" id="edit_model_no" name="model_no" type="text" placeholder="Enter Model no">
                                <span class="text-danger invalid model_no_err"></span>
                            </div>    
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="text-danger invalid exampleInputdate_err"></span>
                            </div>
                    </div>
                </div>
                <div class="card-footer">
    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
            ...
            if (!data.error) {
                ...
                $("#edit_model_no").val(data.vehicle.model_no);
                $("#edit_date").val(data.vehicle.date);
            } else {
                alert(data.error);
            }
        },
