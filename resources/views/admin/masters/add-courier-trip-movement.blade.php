<x-admin.layout>
    <x-slot name="title">Courier Trip Movement List</x-slot>
    <x-slot name="heading">Courier Trip Movement List</x-slot>
    {{-- <x-slot name="subheading">Test</x-slot> --}}


<div class="row mb-3">
    <div class="col-md-4">
        <label for="filter_client" class="form-label">Filter by Client</label>
