    ...
    <table>
        <tr>
            ...
            <td width="50%">
                ...
                <div class="fw-bold text-left">{{ $invoice->client->name ?? '' }}</div>
                <div class="text-left">{{ $invoice->client->address ?? '' }}</div>
                <div class="text-left"> {{ $invoice->client->city ?? '' }} - {{ $invoice->client->pincode ?? '' }}</div>
            </td>
        </tr>
    </table>
